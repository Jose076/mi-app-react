...
import useLocalStorage from 'C:\Users\josea\Desktop\Proyecto_Web\mi-app-react\src\laboratorios\laboratorio4\Hooks/useLocalStorage';
...
export const NotasProvider = ({ children }) => {
  ...
  const [estadoPersistido, setEstadoPersistido] = useLocalStorage(
    'notas-app',
    estadoInicial
  );
